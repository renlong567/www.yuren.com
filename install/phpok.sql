...
CREATE TABLE IF NOT EXISTS `qinggan_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='购物车' AUTO_INCREMENT=95 ;
...
(94, '1e75vq0ddhr3utt2p0b48kv2t7', 0, 1434288370);
...
(1373, 0, 68, 22, 43, 1, '来自工程师的8项Web性能提升建议', 1424920049, 0, 1, 0, 39, '', '', '', '', '', 'h', 0, 0, '', '0.0000', 0),
...
(1253, 0, 168, 24, 45, 1, '新款男人时尚长袖格子衬衫', 1391830871, 0, 1, 0, 112, '', '', '', '', '', '', 1404983732, 0, '', '158.0000', 1),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='字段管理器' AUTO_INCREMENT=269 ;
